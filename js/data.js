...
const RTD_DEFAULT_DATA = {
 ...
 missions: [
  ...
  video: "assets/img/damerjog.mp4" },
     texteComplet: "Le Président de la République, Son Excellence M. Ismaïl Omar Guelleh, a procédé ce jeudi au Parc industriel de Damerjog au lancement des travaux de construction de deux infrastructures énergétiques et logistiques majeures, comprenant un terminal moderne de stockage de produits pétroliers d’une capacité de 375 000 m³ et un pipeline multiproduit de près de 120 kilomètres reliant Damerjog à Dawanleh, à la frontière éthiopienne. Réalisé avec le concours du groupe nigérian Dangote, dans le cadre d’un investissement estimé à 160 millions de dollars, le projet, auquel a pris part le Premier ministre éthiopien Dr Abiy Ahmed Ali, vise à renforcer la coopération entre Djibouti et l’Éthiopie, sécuriser l’approvisionnement énergétique régional, réduire la pression sur les corridors routiers et consolider le rôle de Djibouti comme plateforme logistique et énergétique régionale. La cérémonie a également été marquée par la signature d’un mémorandum d’entente entre l’Autorité des Ports et des Zones Franches de Djibouti, Ethiopian Investment Holdings et le groupe Dangote." },
