 ...
 missions: [
  ...
  actualites: [
    { img: "assets/img/photos/djibouti-ville.jpg",
      ...
      texteComplet: "Le Président de la République, Son Excellence M. Ismaïl Omar Guelleh, a procédé ce jeudi au Parc industriel de Damerjog au lancement des travaux de construction de deux infrastructures énergétiques et logistiques majeures, comprenant un terminal moderne de stockage de produits pétroliers d'une capacité de 375 000 m³ et un pipeline multiproduit de près de 120 kilomètres reliant Damerjog à Dawanleh, à la frontière éthiopienne. Réalisé avec le concours du groupe nigérian Dangote, dans le cadre d'un investissement estimé à 160 millions de dollars, le projet vise à renforcer la coopération entre Djibouti et l'Éthiopie, sécuriser l'approvisionnement énergétique régional et consolider le rôle de Djibouti comme plateforme logistique régionale. La cérémonie a été marquée par la signature d'un mémorandum d'entente entre l'Autorité des Ports et des Zones Franches de Djibouti, Ethiopian Investment Holdings et le groupe Dangote." },
    { img: "assets/img/photos/foret-du-day.jpg",
      alt: "Journée de sensibilisation à la forêt du Day",
    ...
    { img: "assets/img/photos/lac-abbe.jpg",
      alt: "Valorisation du site du Lac Abbé",
